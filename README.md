...
[![My Skills](https://skillicons.dev/icons?i=javascript,typescript,nodejs,expressjs,npm,pnpm,yarn,git,github,mongodb,postgresql,prisma,markdown,postman,vscode,docker,bash,firebase,linux,ubuntu,debian,mint&theme=dark&perline=15)](https://skillicons.dev)
