...
[![My Skills](https://skillicons.dev/icons?i=html,css,bootstrap,materialui,javascript,typescript,npm,firebase,react,vite,angular,git,github,nodejs,expressjs,mongodb,postgresql,prisma,docker,vscode,postman,heroku,netlify,windows,powershell,wordpress,markdown&theme=dark&perline=15)](https://skillicons.dev)
