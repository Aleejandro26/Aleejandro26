...
[![My Skills](https://skillicons.dev/icons?i=javascript,typescript,npm,git,github,nodejs,expressjs,mongodb,postgresql,prisma,markdown,postman,vscode,docker,bash,firebase,linux,ubuntu,debian,mint&theme=dark&perline=15)](https://skillicons.dev)
