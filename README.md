...
[![My Skills](https://skillicons.dev/icons?i=html,css,bootstrap,materialui,javascript,typescript,git,github,npm,yarn,react,vite,jest,nodejs,expressjs,mongodb,postgresql,prisma,firebase,docker,netlify,aws,heroku,markdown,postman,vscode,windows,powershell,linux,ubuntu&theme=dark&perline=15)](https://skillicons.dev)
