...
[![My Skills](https://skillicons.dev/icons?i=html,css,bootstrap,materialui,react,vite,npm,javascript,typescript,nodejs,expressjs,mongodb,postgresql,prisma,docker,bash,firebase,linux,ubuntu,debian,mint,windows,powershell,markdown,postman,git,github,vscode&theme=dark&perline=15)](https://skillicons.dev)
