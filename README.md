...
[![My Skills](https://skillicons.dev/icons?i=html,css,bootstrap,materialui,javascript,typescript,git,github,githubactions,webpack,npm,react,vite,redux,jest,graphql,nodejs,expressjs,mongodb,postgresql,redis,prisma,firebase,docker,netlify,aws,cloudflare&,cypresstheme=dark&perline=15)](https://skillicons.dev)
