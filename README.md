...
[![My Skills](https://skillicons.dev/icons?i=html,css,bootstrap,react,vite,materialui,javascript,typescript,nodejs,expressjs,npm,yarn,pnpm,git,github,mongodb,postgresql,prisma,markdown,postman,vscode,docker,powershell,bash,firebase,windows,linux,ubuntu,debian,mint&theme=dark&perline=15)](https://skillicons.dev)
