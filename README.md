...
[![My Skills](https://skillicons.dev/icons?i=html,css,bootstrap,materialui,javascript,typescript,npm,firebase,angular,git,github,nodejs,expressjs,mongodb,postgresql,prisma,docker,vscode,postman,heroku,netlify,windows,powershell,markdown&theme=dark&perline=15)](https://skillicons.dev)
