...
[![My Skills](https://skillicons.dev/icons?i=html,css,bootstrap,materialui,react,vite,npm,pnpm,yarn,javascript,typescript,nodejs,expressjs,mongodb,postgresql,prisma,markdown,postman,vscode,docker,bash,powershell,firebase,linux,ubuntu,debian,mint,windows&theme=dark&perline=15)](https://skillicons.dev)
